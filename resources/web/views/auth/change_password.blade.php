...
@section('meta')
    ...
    <meta property="og:url" itemprop="url" content="{!! route('auth.changePassword') !!}" />
    ...
    <meta name="twitter:url" content="{!! route('auth.changePassword') !!}" />
    ...
    <script type="application/ld+json">
        {"@@context":"http://schema.org","@@type":"WebSite","name":"{!! $titleSeo !!}","alternateName":"{!! $descriptionSeo !!}","url":"{!! route('auth.changePassword') !!}" }
    </script>
@stop
@section('content')
                        ...
                        <div class="col-lg-6 col-md-8 m-auto">
                            <div class="card2 card border-0 px-4">
                                <div class="heading_s1">
                                    <h1 class="mb-5">Thay đổi mật khẩu</h1>
                                </div>
                                <form action="{{ route('auth.changePassword') }}" method="POST">
                                    ...
                                    <div class="mt-4">
                                        <input type="password" name="confirm_password" placeholder="Nhập mật khẩu"
                                    ...
                                    <div class="d-grid gap-2 col-12 mx-auto text-center">
                                        <button type="submit" class="btn btn-md btn-block mt-4">Đổi mật khẩu</button>
                                    </div>
                                    <div class="d-grid gap-2 col-12 mx-auto text-center">
