                    ...
                    <div class="item">
                        <div class="info">
                            ...
                            <div class="address">
                                <span>Địa chỉ: </span>
                                {{ $item->address }}
                                , @if(isset($item->ward->wardDescription)){{ $item->ward->wardDescription->name }}@endif
                                , @if(isset($item->district->districtDescription)){{ $item->district->districtDescription->name }}@endif
                                , @if(isset($item->zone->zoneDescription)){{ $item->zone->zoneDescription->name }}@endif
                            </div>
                            <div class="phone">
                        ...
                        <div class="action">
                            <a class="edit"
                               href="{{ route('account.address.edit', ['address_id' => $item->id]) }}">
                                Chỉnh sửa
                            </a>
                            @if(!$item->is_default)
                                <a href="{{ route('account.address', ['remove' => $item->id]) }}"
                                   class="delete">
                                    Xóa
                                </a>
                            @endif
