    ...
    if (reportForm) {
        reportForm.addEventListener('submit', function (e) {
            ...
            .then(data => {
                ...
                if (data && data.success) {
                    reportForm.reset();
                    // Đóng modal Bootstrap 4 nếu có jQuery
                    if (window.jQuery) window.jQuery('#reviewReportModal').modal('hide');
                }
            })
