...
@section('meta')
    ...
    <meta property="og:url" itemprop="url" content="{!! route('auth.register') !!}" />
    ...
    <meta name="twitter:url" content="{!! route('auth.register') !!}" />
    ...
    <script type="application/ld+json">
        {"@@context":"http://schema.org","@@type":"WebSite","name":"{!! $titleSeo !!}","alternateName":"{!! $descriptionSeo !!}","url":"{!! route('auth.register') !!}"}
    </script>
@stop
@section('content')
                            ...
                            <div class="card2 card border-0 px-4">
                                ...
                                <form action="{{ route('auth.register') }}" method="POST">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        @endif
                                        <input type="hidden" name="nation_phone_code" value="+84">
                                    </div>
                                    <div class="d-grid gap-2 col-12 mx-auto text-center">
                                        <button type="submit" class="btn btn-md btn-block mt-4">Đăng ký</button>
                                    </div>
                                </form>
                                <div class="with-social mt-30 mb-20">
                                    <div class="line"></div>
                                ...
                                <div class="row mb-40 text-center">
                                    <p class="text-secondary">Bạn đã có tài khoản tại {{ getConfigDb('config_name') }}?
                                        &nbsp<a href="{{ route('auth.login') }}" class="text-danger">Đăng nhập</a>
                                    </p>
                                </div>
                            </div>
                        </div>
