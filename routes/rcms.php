...
use App\Http\Controllers\Api\Cms\BlogTagController;
...
use App\Http\Controllers\Api\Cms\CountryController;
...
use App\Http\Controllers\Api\Cms\StockStatusController;
...
use App\Http\Controllers\Api\Cms\TaxClassController;
use App\Http\Controllers\Api\Cms\TaxRateController;
use App\Http\Controllers\Api\Cms\UserController;
use App\Http\Controllers\Api\Cms\WardController;
use App\Http\Controllers\Api\Cms\WeightClassController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('cms.permission')->group(function () {
        ...
        Route::cmsApiResource('effect', EffectController::class);
        Route::cmsApiResource('safety', SafetyController::class);
        Route::cmsApiResource('skincare', SkincareController::class);
        ...
        Route::cmsApiResource('stock-status', StockStatusController::class);
        ...
        Route::cmsApiResource('blog-category', BlogCategoryController::class);
        Route::cmsApiResource('blog-tag', BlogTagController::class);
        ...
        Route::cmsApiResource('language', LanguageController::class);
        Route::cmsApiResource('currency', CurrencyController::class);
        Route::cmsApiResource('country', CountryController::class);
        Route::cmsApiResource('length-class', LengthClassController::class);
        Route::cmsApiResource('weight-class', WeightClassController::class);
        ...
        Route::cmsApiResource('payment', PaymentController::class);
        Route::cmsApiResource('zone', ZoneController::class);
        Route::cmsApiResource('district', DistrictController::class);
        Route::cmsApiResource('ward', WardController::class);
        Route::cmsApiResource('geo-zone', GeoZoneController::class);
        Route::cmsApiResource('tax-class', TaxClassController::class);
        Route::cmsApiResource('tax-rate', TaxRateController::class);
