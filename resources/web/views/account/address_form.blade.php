            ...
            $.ajax({
                ...
                success: function(json) {
                    if (json && json.success === true) {
                        var input = '<option value="">--Chọn--</option>';
                        var data = json.data || [];
                        for (var i = 0; i < data.length; i++) {
                            var selected = (String(data[i].id) === String(selectedId)) ? ' selected' : '';
                            input += '<option value="' + data[i].id + '"' + selected + '>' + data[i].name +
                                '</option>';
                        }
                        $('#inputZone').html(input);
                    }
                },
            });
        }
            ...
            <div class="card-body">
                <form action="{{ route('account.address.edit') }}" method="post" class="mt-30">
                    ...
                    <div class="row mb-30">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="full_name" id="inputFullName" placeholder="Họ tên"
                                value="{{ old('full_name', $entity?->fullName) }}"
                    ...
                    <div class="row mb-30">
                        ...
                        <div class="col-sm-10">
                            <select id="inputDistrict" name="district_id" onchange="changeDistrict(this)"
                    ...
                    <div class="row mb-30">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="isDefaultCheck" name="is_default"
                                    value="1" @if ($entity?->isDefault) checked @endif />
