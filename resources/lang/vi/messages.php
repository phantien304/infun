...
return [
    ...
    'checkout' => [
        ...
        'coupon' => [
            ...
            'type_percent'           => 'Giảm theo %',
            'type_fixed'             => 'Giảm cố định',
            'type_freeship'          => 'Miễn phí vận chuyển',
            'type_fallback'          => 'Voucher',
            'scope_all_label'        => 'Tất cả sản phẩm',
            'scope_products_label'   => 'Một số sản phẩm',
            'scope_categories_label' => 'Một số ngành hàng',
            'discount_percent'       => 'Giảm %s%%',
            'discount_percent_max'   => 'Giảm %s%% tối đa %s',
            'discount_fixed'         => 'Giảm %s',
            'min_subtotal_any'       => 'Không giới hạn',
            'min_subtotal_from'      => 'Đơn từ %s',
            'expiry_none'            => 'Không giới hạn',
            'expiry_expired'         => 'Đã hết hạn',
            'expiry_hours'           => 'Còn %s giờ',
        ...
        'gift' => [
            'label'                => 'Quà tặng',
            'trigger_min_subtotal' => 'Đơn tối thiểu',
            'trigger_buy_specific' => 'Mua sản phẩm chỉ định',
            'trigger_special'      => 'Điều kiện đặc biệt',
            'pick_auto'            => 'Tự động tặng kèm',
            'pick_one_of_n'        => 'Chọn 1 quà',
            'pick_up_to_n'         => 'Chọn nhiều quà',
            'pick_up_to_limit'     => 'Chọn tối đa %s quà',
            'pick_fallback'        => 'Chọn quà',
            'min_subtotal_any'     => 'Không giới hạn',
            'min_subtotal_from'    => 'Đơn từ %s',
            'expiry_none'          => 'Không giới hạn',
            'expiry_expired'       => 'Đã hết hạn',
            ...
            'expiry_date'          => 'HSD: %s',
            'need_more'            => 'Cần mua thêm %s',
            'not_in_cart'          => 'Chưa có SP áp dụng trong giỏ',
            'invalid_items'        => 'Quà không hợp lệ',
            'auto_take_all'        => 'Quà tự động — phải nhận tất cả',
            'pick_exactly_one'     => 'Phải chọn đúng 1 quà',
            'pick_limit_max'       => 'Chỉ được chọn tối đa %s quà',
            'not_found'            => 'Quà #%s không tồn tại hoặc không còn hiệu lực',
            'exhausted'            => 'Rất tiếc, quà tặng %s vừa hết nên không kèm theo đơn hàng này.',
            'modal_title'          => 'Chọn quà tặng',
            'modal_empty'          => 'Chưa có quà nào',
            'modal_picked_prefix'  => 'Đã chọn',
            'modal_picked_suffix'  => 'quà',
            'js_max_per_gift'      => 'Tối đa %s quà cho voucher này',
            'js_pick_error'        => 'Lỗi nhận quà',
        ],
        'payment_init_failed'    => 'Đơn hàng đã được tạo nhưng chưa kết nối được cổng thanh toán. Vui lòng thanh toán lại trong mục đơn hàng.',
