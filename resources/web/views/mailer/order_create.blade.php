    ...
    <div style="width: 680px;">
        <div style="text-align:center;margin-bottom: 15px;">
            <a href="{{ getConfigDb('config_storage_domain') }}" title="{{ getConfigDb('config_name') }}">
                <img src="{{ thumbnail(getConfigDb('config_logo'), 140, 50, 'client') }}"
                    alt="{{ getConfigDb('config_name') }}" style="margin-bottom: 20px; border: none;" />
            </a>
        </div>
        <p style="margin-top: 0px; margin-bottom: 20px;">
            Cám ơn bạn đã đặt hàng tại {{ getConfigDb('config_name') }}. Đơn hàng của bạn đã được ghi nhận và sẽ được xử
            lý ngay.
        </p>
        ...
        <p style="margin-top: 0px; margin-bottom: 20px;">
            <a
                href="{{ getConfigDb('config_storage_domain') . '/order/search?order_code=' . $infoCustomer['uniqid'] }}">
