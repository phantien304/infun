...
<div class="review-write" id="reviewWriteAnchor">
        ...
        <div class="rw-login-prompt">
            ...
            <p>
                @if ($effPolicy === $policyVerified)
                    Vui lòng <a href="{{ routeArea('auth.login') }}">đăng nhập</a>
                    và mua sản phẩm để có thể đánh giá.
                @else
                    Vui lòng <a href="{{ routeArea('auth.login') }}">đăng nhập</a> để viết đánh giá.
                @endif
            </p>
        </div>
    ...
    @else
        <details class="rw-collapse" open>
            ...
            <form action="{!! routeArea('review.saveReview') !!}" method="post" enctype="multipart/form-data" class="rw-form"
                id="reviewWriteForm">
                @csrf
                ...
                <div class="rw-actions">
                    <button type="submit" class="btn btn-primary rw-submit">Gửi đánh giá</button>
                    <button type="reset" class="btn btn-link rw-reset">Nhập lại</button>
                </div>
            </form>
        </details>
    @endif
